...
from Yukinon import pbot as Client
    ...
    try:
        await client.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton(text="🤍----𝓘𝓶𝓪𝓰𝓮 𝓔𝓭𝓲𝓽𝓸𝓻----🤍",callback_data="waifu"),],
                    [
                    ...
                    [InlineKeyboardButton(text="🤍----𝚈𝚞𝚔𝚒𝚗𝚘 𝚈𝚞𝚔𝚒𝚗𝚘𝚜𝚑𝚒𝚝𝚊----🤍",callback_data="yuki"),],
                ]
            ),
    ...
    if lel == user_id:
        if query.data == "removebg":
            ...
            await query.message.edit(
             ...
             await query.message.edit_text("**Powered By:** @waifuNetwork")
        elif query.data == "yuki":
             await query.message.edit_text("**Module Belongs To:** @tr0j3n")        
